  ...
  return (
    <section id="about" className="py-24 px-6 lg:px-12 relative">
      <div className="max-w-6xl mx-auto">
        <div ref={ref} className={`grid lg:grid-cols-2 gap-12 items-start transition-all duration-700 ${
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 pt-6 border-t border-border">
              <div className="flex justify-between items-center py-2">
                <span className="text-muted-foreground text-sm">Lokace</span>
                <span className="font-medium">Brno, CZ</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-muted-foreground text-sm">Focus</span>
                <span className="font-medium">Backend / Bots</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-muted-foreground text-sm">Od roku</span>
              ...
              <div className="pt-4 border-t border-border">
                <div className="flex flex-wrap gap-2">
                  {["Java", "JavaScript", "TypeScript", "Node.js", "Discord.js"].map((tech) => (
                    <span key={tech} className="px-3 py-1 bg-muted text-sm rounded">
                      {tech}
                    </span>
                  ))}
                </div>
